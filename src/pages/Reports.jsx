                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="border rounded-lg p-4 bg-blue-50">
                      <h4 className="text-md font-semibold mb-2">Jewellery Summary</h4>
                      <p>
                        <strong>Total Jewellery Types:</strong> {jewelleryData.totalCount || 0}
                      </p>
                    </div>
                    <div className="border rounded-lg p-4 bg-green-50">
                      <h4 className="text-md font-semibold mb-2">Stock Summary</h4>
                      <p>
                        <strong>Total Stock Items:</strong> {jewelleryData.totalStockCount || 0}
                        <br />
                        <strong>Available Stock Items:</strong> {jewelleryData.availableStockCount || 0}
                      </p>
                    </div>
                    <div className="border rounded-lg p-4 bg-yellow-50">
                      <h4 className="text-md font-semibold mb-2">Stock Status</h4>
                      <div>
                        {jewelleryData.stockStatusCounts?.map((status, index) => (
                  ...
                  <h4 className="text-md font-semibold mb-2">Jewellery Inventory</h4>
                  ...
                  <h4 className="text-md font-semibold mb-2">Detailed Stock Items</h4>
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Type</th>
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Model No</th>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {jewelleryData.stockDetails?.map((item, index) => (
                          <tr key={`stock-${item.Jewellery_id}-${item.Model_No}-${item.Unit_id}`} 
                              className={item.Status === 'Sold' ? 'bg-red-50' : (item.Quantity <= 0 ? 'bg-yellow-50' : 'bg-green-50')}>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.Type}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.Model_No}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.Unit_id}</td>
